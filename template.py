...
https://github.com/lilalajemima/alu_regex-data-extraction-group9.githttps://github.com/lilalajemima/alu_regex-data-extraction-group9.githttps://github.com/lilalajemima/alu_regex-data-extraction-group9.git    'phone_number': r'\(?\d{3}\)?[.\s-]?\d{3}[.\s-]?\d{4}',
...
# New test data samples for each featurehttps://github.com/lilalajemima/alu_regex-data-extraction-group9.git# New test data samples for each featurehttps://github.com/lilalajemima/alu_regex-data-extraction-group9.git
test_data = {
    ...
    tt data samples for each featurehttps://github.com/lilalajemima/alu_regex-data-extraction-group9.git
    test_data = {
            'email': ['jane_doe23@website.net', 'contact@business.co.jp', 'support@domain.org'],
                'url': ['https://shop.example.io/products', 'http://docs.sample-site.com/manual'],
                    'phone_number': ['(555) 123-4567', '987-654-3210', '555.987.6543'],
                        'credit_card': ['4321 8765 2109 6543', '4321-8765-2109-6543'],
                            'time_24h': ['09:15', '23:59'],
                                'time_12h': ['10:45 AM', '11:15 PM', '6:00 pm'],
                                    'html_tag': ['<h1>Hello World</h1>', '<span class="highlight">Text</span>', '<a href="link.html">Click here</a>'],
                                        'hashtag': ['#CoolTech', '#PythonRocks', '#100DaysOfCode'],
                                            'currency': ['$5.00', '$999.99', '$12,345.67']st_data = {
    'email': ['jane_doe23@website.net', 'contact@business.co.jp', 'support@domain.org'],
    'url': ['https://shop.example.io/products', 'http://docs.sample-site.com/manual'],
    'phone_number': ['(555) 123-4567', '987-654-3210', '555.987.6543'],
    'credit_card': ['4321 8765 2109 6543', '4321-8765-2109-6543'],
